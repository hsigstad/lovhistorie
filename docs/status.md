...
**Convergence: 67.0%** (OCR-calibrated) &nbsp;·&nbsp; 555/829
statutory dev-set provisions &nbsp;·&nbsp; **58.5%** at the strict ≥98% bar
...
flatter the number. The strict all-laws-≥98% figure (58.5%) is always shown
...
| aksjeloven (`1997-06-13-44`) | 181/291 @90% |
