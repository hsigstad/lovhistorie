...
**Convergence: 68.5%** (OCR-calibrated) &nbsp;·&nbsp; 568/829
statutory dev-set provisions &nbsp;·&nbsp; **59.7%** at the strict ≥98% bar
&nbsp;·&nbsp; anti-gaming guards **PASS** &nbsp;·&nbsp; as of 2026-08-21.
...
flatter the number. The strict all-laws-≥98% figure (59.7%) is always shown
...
| Law | Converged |
|---|---|
| avtaleloven (`1918-05-31-4`) | 33/45 @90% |
...
| verdipapirhandelloven (`2007-06-29-75`) | 212/268 @98% |
