...
**Convergence: 68.9%** (OCR-calibrated) &nbsp;·&nbsp; 571/829
statutory dev-set provisions &nbsp;·&nbsp; **60.3%** at the strict ≥98% bar
...
flatter the number. The strict all-laws-≥98% figure (60.3%) is always shown
...
| oreigningslova (`1959-10-23-3`) | 18/31 @90% |
...
| aksjeloven (`1997-06-13-44`) | 190/291 @90% |
